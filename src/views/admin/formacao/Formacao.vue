...
<script>
import Layout from "../../../components/admin/formacao/Layout";
import Dialog from "../../../components/dialogs/Dialog.vue";
import FormFormacao from "../../../components/forms/Formacao.vue";
import itemsMixin from '@/mixins/items'

export default {
  components: { FormFormacao, Dialog, Layout },
  mixins: [itemsMixin],
  data: () => ({
    namespace: "formacoes",
