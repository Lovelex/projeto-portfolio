<template>
  <div>
    ...
    <AdminWrapper name="Qualificacao">
...
<script>
import Layout from "../../../components/admin/qualificacao/Layout";
import Dialog from "../../../components/dialogs/Dialog.vue";
import FormQualificacao from "../../../components/forms/Qualificacao.vue";

export default {
  components: { FormQualificacao, Dialog, Layout },
  data: () => ({
    namespace: "qualificacoes",
